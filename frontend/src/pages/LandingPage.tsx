        ...
        <div className="relative min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-sky-100 dark:from-neutral-900 dark:via-gray-400 dark:to-gray-400">
            ...
            <div className="min-h-screen flex flex-col items-center justify-center gap-7 tracking-wide">
                ...
                <div className="flex flex-row items-center gap-8">
                    ...
                    <button onClick={() => navigate("/login")} className="bg-transparent text-black border-2 border-blue-700 text-xl py-2 px-7 rounded-lg cursor-pointer shadow-sm transition-all duration-200 ease-in-out hover:translate-y-0.5 hover:shadow-lg">Login</button>
                </div>
            </div>
        </div>
        </>
